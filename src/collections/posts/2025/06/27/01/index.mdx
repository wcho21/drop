...
summary: "직접 프로그램을 만들며 배우는 기초 문법"
...
셸의 설치 방법을 다루지는 않겠지만, 윈도우에서는 Cygwin 같은 환경을, 맥이나 리눅스에서는 기본적으로 설치된 Bash 셸을 그대로 이용할 수 있습니다.
...
앞으로의 내용은 셸 스크립트를 작성해본 경험이 없다고 가정하고 진행합니다.
그러면 시작해봅시다.

...
- *The Art of Computer Programming, Vol. 3* (2nd ed., Donald Knuth, 1998), 또는 *The Art of Computer Programming 3* (한빛미디어, 2008): 인버전의 평균 개수.
...
- [*Reorder Data in Log Files*][leetcode-reorder] (Leetcode): 본문에서 동물 병원 문제로 언급한 것과 비슷한 문제.

...
- *Beautiful Code* (Andy Oram, Greg Wilson, 2007): 자바스크립트<L>JavaScript</L>로 구현한 프랫 파서 소개.

- *Top Down Operator Precedence* (Vaughan R. Pratt, 1973)

- [*Top Down Operator Precedence*][crockford] (crockford.com): 위 Beautiful Code 책의 내용과 동일.

- [*Simple but Powerful Pratt Parsing*][matklad] (matklad.github.io): 러스트<L>Rust</L>로 구현한 프랫 파서 소개.

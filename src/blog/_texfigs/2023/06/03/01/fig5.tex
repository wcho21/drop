...
\newcommand\drawpoparr{
  \draw[arr] (-\arrowwidth/2,\arrowheight) .. controls +(-15:6pt) and +(up:10pt) .. ++(\arrowwidth,-\arrowheight);
}
\newcommand\drawpusharr{
  \draw[arr] (\stackwidth-\arrowwidth/2,0pt) .. controls +(up:10pt) and +(195:6pt) .. ++(\arrowwidth,\arrowheight);
}

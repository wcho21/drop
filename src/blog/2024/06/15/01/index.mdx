...
<Alg>
  <AK>퀵셀렉트</AK> ($\textit{arr}$, $k$)&nbsp;<AC>// $\textit{arr}$에서 $\textit{k}$ 번째로 작은 데이터를 리턴</AC>
...
<Alg>
  <AK>파티셔닝</AK> ($\textit{arr}$, $\textit{begin}$, $\textit{end}$)&nbsp;<AC>// $\textit{arr}$의 구간 [$\textit{begin}$, $\textit{end}$)을 둘로 나누는 피벗 인덱스를 리턴</AC>
...
<Alg>
  <AK>랜더마이즈드 파티셔닝</AK> ($\textit{arr}$, $\textit{begin}$, $\textit{end}$)&nbsp;<AC>// $\textit{arr}$의 구간 [$\textit{begin}$, $\textit{end}$)을 둘로 나누는 피벗 인덱스를 리턴</AC>
...
<Alg>
  <AK>파티셔닝</AK> ($\textit{arr}$, $\textit{begin}$, $\textit{end}$)&nbsp;<AC>// $\textit{arr}$의 구간 [$\textit{begin}$, $\textit{end}$)을 세 부분으로 나누는 피벗 구간을 리턴</AC>

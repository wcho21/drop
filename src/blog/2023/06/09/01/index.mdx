...
<Alg>
  ...
  <ABlock>
    <AIf>코드 포인트가 7비트 이하 값</AIf>
    <ABlock>
      xxx xxxx $\leftarrow$ 코드 포인트의 이진 표현

      <ARet>바이트 시퀀스 0xxx xxxx</ARet>
    </ABlock>

    <ANL />

    <AIf>코드 포인트가 11비트 이하 값</AIf>
    <ABlock>
      yyy yyxx xxxx $\leftarrow$ 코드 포인트의 이진 표현

      <ARet>바이트 시퀀스 110y yyyy 10xx xxxx</ARet>
    </ABlock>
    ...
    <ABlock>
      ...
      <ARet>바이트 시퀀스 1110 zzzz 10yy yyyy 10xx xxxx</ARet>
    </ABlock>
    ...
    <ABlock>
      ...
      <ARet>바이트 시퀀스 1111 0www 10zz zzzz 10yy yyyy 10xx xxxx</ARet>
    </ABlock>
...
<Alg>
  ...
  <ABlock>
    <AIf>바이트 시퀀스가 0xxx xxx 꼴</AIf>
    <ABlock>
      <ARet>코드 포인트 xxx xxxx</ARet>
    </ABlock>

    <ANL />

    <AIf>바이트 시퀀스가 110x xxxx 10yy yyyy 꼴</AIf>
    <ABlock>
      <ARet>코드 포인트 xxx xxyy yyyy</ARet>
    </ABlock>

    <ANL />

    <AIf>바이트 시퀀스가 1110 xxxx 10yy yyyy 10zz zzzz 꼴</AIf>
    <ABlock>
      <ARet>코드 포인트 xxxx yyyy yyzz zzzz</ARet>
    </ABlock>

    <ANL />

    <AIf>바이트 시퀀스가 1111 1xxx 10yy yyyy 10zz zzzz 10ww wwww 꼴</AIf>
    <ABlock>
      <ARet>코드 포인트 x xxyy yyyy zzzz zzww wwww</ARet>
    </ABlock>

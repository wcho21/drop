...
<FigureDisplay>
  <FigureV2 src={fig3} alt="Building lego">
    <FigureCaption slot="caption">존재한다고 아는 것과 구체적으로 만들어내는 일은 정말로 다릅니다. 당시 직관주의가 요구한 구성적인 방법은 오늘날 프로그래밍에도 이어지고 있는 것이 아닐까요. -- 사진: [Sebastien Bonneval][unsplash-sb]</FigureCaption>
  </FigureV2>
</FigureDisplay>

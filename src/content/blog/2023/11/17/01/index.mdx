...
<FigureV2 src={fig2} alt="Logical axioms">
  <FigureCaption slot="caption">그림 1. 수학 원리 책에서 쓰인 논리 규칙 일부. 예를 들어 2번 규칙은, 'p 또는 p라면, p이다.' 라는 것을 정당화합니다. 나머지도 이처럼 겉보기에 당연해 보이는 것을 규칙으로 나열한 것입니다. -- 출처: [University of Michigan Historical Math Collection][univ-michigan]</FigureCaption>
</FigureV2>
...
<FigureDisplay>
  <FigureV2 src={fig1} alt="Mirror reflection">
    <FigureCaption slot="caption">괴델은 자기 자신 언급을 피할 수 없음을 보였습니다. 그리고 그것은 수학 자체가 가진 성질이었습니다. 이것은 인류에게 재앙일까요, 선물일까요. 아니면 둘 다일까요. -- 사진:  [Jametlene Reskp][unsplash-jr]</FigureCaption>
  </FigureV2>
</FigureDisplay>
...
<FigureDisplay>
  <FigureV2 src={fig3} alt="Building lego">
    <FigureCaption slot="caption">존재한다고 아는 것과 구체적으로 만들어내는 일은 정말로 다릅니다. 당시 직관주의가 요구한 구성적인 방법은 오늘날 프로그래밍에도 이어지고 있는 것인지도 모릅니다. -- 사진: [Sebastien Bonneval][unsplash-sb]</FigureCaption>
  </FigureV2>
</FigureDisplay>
...
그 숫자에 그 튜링 머신이 하는 일을 기록할 수 있는데요.
...
<FigureDisplay>
  <FigureV2 src={fig4} alt="Building lego">
    <FigureCaption slot="caption">무의미한 기호를 규칙에 따라 '기계적으로' 조작하는 일로서 수학을 바라볼 수 있습니다. 마치 무엇을 하는지 의미를 모르면서 계산을 해내는 지금의 컴퓨터가 떠오르진 않으신가요. -- 사진: [Robert Gareth][unsplash-rg]</FigureCaption>
  </FigureV2>
</FigureDisplay>

...
<Figure
  src={fig1}
  alt="unicode-utf mapping"
  caption="유니코드와 UTF-8 매핑" />
...
<Figure
  src={fig3}
  alt="prefixes in utf-8"
  caption="UTF-8 바이트 비트 패턴" />
...
<Figure
  src={fig4}
  alt="code space and planes"
  caption="유니코드의 코드 스페이스와 플레인" />
...
<Figure
  src={fig5}
  alt="various utf encoding examples"
  caption="같은 문자의 세 UTF 인코딩" />

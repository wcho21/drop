...
<Figure
  src={fig1}
  alt="Five kinds of binary trees with three nodes"
  caption="세 노드를 가진 트리들" />
...
사실 카탈란 넘버 $C_n$는 다음과 같은 [점화식][wiki-recur-rel]<AltLang>Recurrent relation</AltLang>으로 정의할 수 있습니다.
...
<Figure
  src={fig2}
  alt="Four cases of binary tress with four nodes"
  caption="네 개의 노드일 때의 패턴" />
...
<Figure
  src={fig3}
  alt="Successful and failed case of handshaking"
  caption="악수 문제 규칙" />

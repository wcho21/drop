...
import texfig1 from "@texfigs/2023/06/02/01/fig1.svg";
import texfig2 from "@texfigs/2023/06/02/01/fig2.svg";
import texfig3 from "@texfigs/2023/06/02/01/fig3.svg";
import texfig4 from "@texfigs/2023/06/02/01/fig4.svg";
...
<Figure src={texfig1} alt="Five kinds of binary trees with three nodes">
...
<Figure src={texfig2} alt="Four cases of binary tress with four nodes">
...
<Figure src={texfig3} alt="Successful and failed case of handshaking">
...
<Figure src={texfig4} alt="Handshaking diagram">

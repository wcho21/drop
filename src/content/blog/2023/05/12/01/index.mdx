...
<Alg>
  ...
  <ABlock>
    ...
    <AK>다음을</AK> 후위 표기식의 토큰<AK>마다 반복</AK>
    <ABlock>
      <AK>만약</AK> 토큰이 숫자이면
      <ABlock>
        $\textit{stack}$.push(토큰)
...
<Alg>
  ...
  <ABlock>
    ...
    <AK>다음을</AK> 중위 표기식의 토큰<AK>마다 반복</AK>
    <ABlock>
      <AK>만약</AK> 토큰이 숫자이면
      <ABlock>
      ...
      <AK>아니면 만약</AK> 토큰이 연산자이면
      <ABlock>
        <AC>// 토큰보다 우선순위가 높지 않은 것들을 스택에서 꺼냄</AC>

        <AK>다음을</AK> 토큰의 우선순위 > $\textit{stack}$.peek()의 우선순위인 <AK>동안 반복</AK>
        <ABlock>
      ...
      <AK>아니면 만약</AK> 토큰이 &lsquo;(&rsquo;이면
      <ABlock>
        $\textit{stack}$.push(토큰)
      </ABlock>
      ...
      <AK>아니면 만약</AK> 토큰이 &lsquo;)&rsquo;이면
      <ABlock>
        <AK>다음을</AK> 스택 맨 위가 &lsquo;(&rsquo;일 때<AK>까지 반복</AK>
        <ABlock>
          $\textit{postfix}$.append(토큰)
        </ABlock>
      </ABlock>

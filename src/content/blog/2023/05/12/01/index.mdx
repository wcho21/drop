...
<Figure
  src={fig1}
  alt="Calculating postfix expression 12+ with stack"
  caption="스택으로 후위 표기식 계산하기"
/>
...
<Figure
  src={fig2}
  alt="Converting to postfix expression with stack"
  caption="스택으로 표기식 변환하기"
/>
...
<Figure
  src={fig3}
  alt="Handling operators having the same priority"
  caption='우선순위가 "같은" 연산 기호 처리하기'
/>
...
<Figure
  src={fig4}
  alt="Answer to the second exercise"
  caption='두 번째 연습문제: 우선순위가 "다른" 경우 처리하기'
/>
...
<Figure
  src={fig5}
  alt="Handling parentheses"
  caption="괄호를 만난 경우 처리하기"
/>

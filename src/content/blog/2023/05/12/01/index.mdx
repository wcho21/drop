...
import texfig1 from "@texfigs/2023/05/12/01/fig1.svg";
import texfig2 from "@texfigs/2023/05/12/01/fig2.svg";
import texfig3 from "@texfigs/2023/05/12/01/fig3.svg";
import texfig4 from "@texfigs/2023/05/12/01/fig4.svg";
import texfig5 from "@texfigs/2023/05/12/01/fig5.svg";
...
\begin{align*}
  ...
  \rightarrow{} & \texttt{\fbox{1(23+)*}} &&{} \\
  \rightarrow{} & \texttt{\fbox{123+*}}   &&\text{\small (postfix)}
\end{align*}
$$

그러면 예시로 든 `1*(2+3)`은 `1(23+)*`이 됩니다.
그리고 괄호는 사실 필요가 없습니다.
...
<Figure src={texfig1} alt="Calculating postfix expression 12+ with stack">
...
<Figure src={texfig2} alt="Converting to postfix expression with stack">
...
<Figure src={texfig3} alt="Handling operators having the same priority">
...
<Figure src={texfig4} alt="Answer to the second exercise">
...
<Figure src={texfig5} alt="Handling parentheses">

...
<Figure
  src={fig3}
  alt="Memory diagram example"
  caption="메모리 다이어그램 예시: -2.75" />
...
부동소수점 처리는 컴퓨터 하드웨어와 관련이 있는데요.
Computer Organization and Design (Patterson, Hennessy)와 같은 컴퓨터 구조 책에서 부동소수점 설명을 찾아볼 수 있습니다.

...
import fig4 from "@texfigs/2024/06/15/01/fig4.jpg";
...
이는 다음 테스트 코드와 같이 사용할 수 있습니다.
여기서 파티셔닝은 항상 마지막 위치를 피벗으로 고르지만, 실제론 어떤 파티셔닝이든 상관없이 동작합니다.

...
파서는 소스 코드를 해석한 결과로 추상 문법 트리<L>abstract syntax tree</L>를 만듭니다.
즉 다음과 같은 코드를 문법적으로 분석합니다.

```
g = 98/10
```

그러면 파서는 '대입 문법'을 잘 지킨 코드로 확인함과 동시에, 그 문법 구조를 나타내는 트리를 만듭니다.
...
<Figure src={fig1} alt="binding power for plus">
...
<Figure src={fig2} alt="binding powers for plus and asterisk">
...
<Figure src={fig3} alt="binding powers for equal sign">
...
<Figure src={fig4} alt="parsing additions">
